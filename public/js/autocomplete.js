...
/* ADD AUTOCOMPLETE TO ITEMS IN THE DOM */
console.log("Adding autocomplete functionality to tagSearch");
// example adapted from https://www.javascripttutorial.net/javascript-fetch-api/
fetch("/products/allTags")
