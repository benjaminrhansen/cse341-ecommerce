...
// we can define a schema to specify what is 
// required, what is not, to allow us to 
// program better and enhance security maybe? hopefully...
const productSchema = new Schema({
  ...
  userId: {
    ...
    // ref tells mongoose which object id is "actually related to the data in here (this document)"
    ref: 'User', // a relation to the User Model
    required: true
  }
});
